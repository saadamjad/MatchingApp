      ...
      <SafeAreaView style={{flex:1}}>
        ...
        <View style={styles.cont}>
          ...
          <View style={{ alignItems:'center' }}>
            <TouchableOpacity style={{ backgroundColor:'#ff1822', paddingHorizontal:30, paddingVertical:10, borderRadius:20 }}>
              <Text style={{ color:'#fff', fontSize:14, fontFamily:'Poppins-SemiBold' }}>UPDATE PASSWORD</Text>
            </TouchableOpacity>
          </View>
        </View>
        </SafeAreaView>
...
const styles={
  ...
  cPassTxt:{fontSize:12, fontFamily:'Poppins-Bold', color:'#242424', marginLeft:10},
  inputFld:{    
    marginLeft:10,
    color:'#242424',
    width:'90%',
