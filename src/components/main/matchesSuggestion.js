...
import { faHeart , faUserPlus, faEye, faFemale, faTimes } from '@fortawesome/free-solid-svg-icons';
  ...
  render() {
    return(
      <SafeAreaView style={{flex:1}}>
        <Header name={'Matches Suggestion'} navigation={this.props.navigation} />
        <View style={styles.vipUserView}>
          <Swiper 
            ...
            <View style={styles.vipUserInner}>
              <View style={{ flex:1, paddingRight:0, borderRadius:10, backgroundColor:'#f6f6f6', shadowColor: "#000", shadowOffset: { width: 0, height: 1, }, shadowOpacity: 0.22, shadowRadius: 2.22, elevation: 2, }}>
        ...
        <View style={{ paddingHorizontal:25, marginTop:10, flexDirection:'row' }}>
          <View style={{ flex:1 , alignItems:'center' }}>
            <TouchableOpacity style={{ width:50, height:50, borderRadius:50, backgroundColor:'blue', justifyContent:'center', alignItems:'center' }}>
              <FontAwesomeIcon icon={faHeart} color="#fff" size={26} />  
            </TouchableOpacity>
          </View>
          <View style={{ flex:1, alignItems:'center'  }}>
            <TouchableOpacity style={{ width:50, height:50, borderRadius:50, backgroundColor:'red', justifyContent:'center', alignItems:'center' }}>
              <FontAwesomeIcon icon={faUserPlus} color="#fff" size={26} />  
            </TouchableOpacity>
          </View>
          <View style={{ flex:1, alignItems:'center'  }}>
            <TouchableOpacity style={{ width:50, height:50, borderRadius:50, backgroundColor:'orange', justifyContent:'center', alignItems:'center' }}>
              <FontAwesomeIcon icon={faEye} color="#fff" size={26} />  
            </TouchableOpacity>
          </View>
          <View style={{ flex:1, alignItems:'center'  }}>
            <TouchableOpacity style={{ width:50, height:50, borderRadius:50, backgroundColor:'grey', justifyContent:'center', alignItems:'center' }}>
...
const styles={
  ...
  regularImageDimension:{ width:140 , height:145, borderTopLeftRadius:10,borderBottomLeftRadius:10 },
  vipContentView:{ flex: 1, flexDirection:'row', paddingLeft:0 , position:'absolute', bottom:0, backgroundColor:'rgba(255,255,255,0.5)', width:'100%'},
