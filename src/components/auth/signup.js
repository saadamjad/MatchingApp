...
import { View, Text, TouchableOpacity , Dimensions, Image , TextInput , CheckBox , Picker , ScrollView, BackHandler , StatusBar} from 'react-native';
      ...
      <View style={styles.headerView}>
        ...
        <View style={styles.getStartedView}>
          <TouchableOpacity onPress={()=>{ this.setState({ step:0 }) }} style={this.state.step == 0 ? styles.selectedCircle : styles.notSelectedCircle} activeOpacity={0.8}>
            <Text style={this.state.step == 0 ? styles.selectedTxt : styles.notSelectedTxt}>1</Text>
          </TouchableOpacity>            
        ...
        <View style={styles.verificationView}>
          <TouchableOpacity onPress={()=>{ this.setState({ step:1 }) }} style={this.state.step == 1 ? styles.selectedCircle : styles.notSelectedCircle} activeOpacity={0.8}>
            <Text style={this.state.step == 1 ? styles.selectedTxt : styles.notSelectedTxt}>2</Text>
          </TouchableOpacity>    
        ...
        <View style={styles.signUpView}>
          <TouchableOpacity onPress={()=>{ this.setState({ step:2 }) }} style={this.state.step == 2 ? styles.selectedCircle : styles.notSelectedCircle} activeOpacity={0.8}>
            <Text style={this.state.step == 2 ? styles.selectedTxt : styles.notSelectedTxt}>3</Text>
          </TouchableOpacity>   
        ...
        <View style={styles.getStarted}>
          {
            this.state.isEmaiForm == true ? 
              <View style={ styles.EmailView }>
                <Text style={[styles.signUpLabel, styles.mb2]}>Sign Up With Email</Text>                
                ...
                <View style={styles.agreedView}>
                  ...
                  />
                  <Text style={styles.agreedTxt}>I agree to the <Text style={styles.agreedtxtSelected}>Privacy Policy</Text> and <Text style={styles.agreedtxtSelected}>Terms and Conditions.</Text></Text>
                </View>
                <View>
              ...
              <View style={ styles.PhoneView }>
                <Text style={[styles.signUpLabel, styles.mb2]}>Sign Up With Phone</Text>
                ...
                <View>
                  <TouchableOpacity onPress={()=>{ this.setState({ isEmaiForm:true }) }}>
                    <Text style={[styles.registerWith, styles.mb2 ]}>Register with Email</Text>
                  </TouchableOpacity>
                </View>
              </View>
          }
      ...
      return (
        <View style={ styles.verification }>
          <View style={ styles.verificationBox }> 
            ...
            <View>
              <TouchableOpacity style={styles.sendBtn} onPress={()=>{ this.setState({ step:2 }) }}>
    ...
    if(this.state.step == 2){
      return (
        <View style={styles.signp}>
          <Text style={[styles.signUpLabel , { marginBottom:5 }]}>Accont Registration</Text>
          <Text style={[styles.signUpSubLabel]}>Meet Elite and Like</Text>
          <Text style={[styles.signUpSubLabel, { marginBottom:15 }]}>Minded Muslim Singles</Text>
          <ScrollView>
            ...
            <View style={[styles.inputFldView, styles.mb2]}>
              <Picker
                style={{ height: 50, width: 280 }}
                selectedValue = {this.state.state} onValueChange = {this.updateState}>
...
const styles = {
  ...
  code:{
    textAlign:'center' , color:'#ff1822', fontFamily:'Poppins-SemiBold', fontSize:18, marginBottom:10,
  },
  borderStyleBase: {
    width: 30,
    height: 45
  ...
  genderView:{
    borderRadius:30,flexDirection:'row',alignItems:'center',paddingHorizontal:20, marginBottom:15  
  },
