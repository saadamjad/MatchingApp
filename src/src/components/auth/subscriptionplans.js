...
export default class subscriptionplans extends Component {
	...
	render() {
		...
		<SafeAreaView style={{flex:1}}>
        	<Header name={'Subscription Plans'}  navigation={this.props.navigation} search={false} drawer={false} />
...
const styles ={
	...
	mb1:{  marginBottom:20 },
	widget:{ backgroundColor:'#ff1723', color:'#fff', width:50, height:50, borderRadius:50, position:'absolute', top:-15, right:0, fontSize:9, fontFamily:'Poppins-Regular', textAlign:'center', paddingTop:10 }
}